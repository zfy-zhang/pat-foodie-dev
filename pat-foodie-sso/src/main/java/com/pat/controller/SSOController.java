...
//        return "login";
    ...
    @ResponseBody
    public ResJSONResult verifyTmpTicket(String tmpTicket,
                                         HttpServletRequest request,
                                         HttpServletResponse response) throws Exception {
        ...
        if (StringUtils.isBlank(tmpTicketValue)) {
            return ResJSONResult.errorUserTicket("用户票据异常");
        }
        ...
        // 验证成功，返回OK，携带用户会话
        return ResJSONResult.ok(JsonUtils.jsonToPojo(userRedis, UsersVO.class));
    }

    @PostMapping("/logout")
    @ResponseBody
    public ResJSONResult logout(String userId,
                                  HttpServletRequest request,
                                  HttpServletResponse response) throws Exception {
