...
//			if (user == null) {
//				returnErrorResponse(response, new ResJSONResult().errorTokenMsg("用户id或密码不正确！"));
//				return false;
//			}
//
...
//			if (days < 0) {
//				returnErrorResponse(response, new ResJSONResult().errorTokenMsg("该账户授权访问日期已失效！"));
//				return false;
//			}
//
//			// 判断限制访问次数
...
//
//		} else {
//			returnErrorResponse(response, new ResJSONResult().errorTokenMsg("请在header中携带支付中心所需的用户id以及密码！"));
//			return false;
//		}
//
//
...
//	public void returnErrorResponse(HttpServletResponse response, ResJSONResult result)
